class CandidatosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @candidato.save
        format.html { redirect_to new_candidato_path, notice: 'Candidatura feita com sucesso.' }
  ...
  private
    ...
    def candidato_params
      params.require(:candidato).permit(:nome, :email, :contacto, :morada, :cv_file_name, :mensagem)
    end
end
