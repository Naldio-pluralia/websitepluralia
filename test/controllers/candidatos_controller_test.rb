...
class CandidatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create candidato" do
    assert_difference('Candidato.count') do
      post candidatos_url, params: { candidato: { contacto: @candidato.contacto, cv: @candidato.cv, email: @candidato.email, mensagem: @candidato.mensagem, morada: @candidato.morada, nome: @candidato.nome } }
    end
  ...
  test "should update candidato" do
    patch candidato_url(@candidato), params: { candidato: { contacto: @candidato.contacto, cv: @candidato.cv, email: @candidato.email, mensagem: @candidato.mensagem, morada: @candidato.morada, nome: @candidato.nome } }
